...
import "./footer.css";
import LogoTip from "../../../lib/img/footer__logo.svg"
import call_Icon from "../../../lib/img/Call.svg"
import Message from "../../../lib/img/Message2.svg"
import Location from "../../../lib/img/Location2.svg"
import Maps from "../../../lib/img/map.png"
import allIcon from "../../../lib/img/payments.svg"
                ...
                <div className="container">
                    <div className="footer__Div">
                        <div className="footer__info">
                            <img src={LogoTip} alt="Logo " className="footer__logo" width={116} height={80} />
                            <a href="#link" className="footer__p">
                                <img src={call_Icon} alt="Icon" className="footer__iconP" width={20} height={20} /> +38093-717-29-29
                            </a>

                            <a href="mailto" className="footer__p">
                                <img src={Message} alt="Icon" className="footer__iconP" width={20} height={20} /> kharkivmebelinfo@gmail.com
                            </a>

                            <a href="#link" className="footer__p">
                                <img src={Location} alt="Icon" className="footer__iconP" width={20} height={20} /> Харьков
                            </a>
...
<svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul className="footer__list">
                            <li className="footer__item">
                                <h6 className="footer__title">Наш магазин</h6>


<a className="footer__link" href="#link">О магазине</a>
                                <a className="footer__link" href="#link">Наши вакансии</a>
                                <a className="footer__link" href="#link">Контакты</a>
                                <a className="footer__link" href="#link">Мебель в рассрочку</a>
                                <a className="footer__link" href="#link">Бренды</a>
                                <a className="footer__link" href="#link">Возврат товара</a>
                                <a className="footer__link" href="#link">Сертификаты</a>
                                <a className="footer__link" href="#link">Обзоры</a>
                            </li>

                            <li className="footer__item">
                                <h6 className="footer__title">Сервис</h6>

                                <a className="footer__link" href="#link">Ваши заказы</a>
                                <a className="footer__link" href="#link">Доставка и оплата</a>
                                <a className="footer__link" href="#link">Сборка мебели</a>
                                <a className="footer__link" href="#link">Хочу в подарок</a>
                                <a className="footer__link" href="#link">Список сравнения</a>
                                <a className="footer__link" href="#link">Карта сайта</a>
                            </li>

                            <li className="footer__item">
                                <h6 className="footer__title">Помощь</h6>

                                <a className="footer__link" href="#link">Статьи</a>
                                <a className="footer__link" href="#link">Вопрос ответ</a>
                                <a className="footer__link" href="#link">Производители</a>
                            </li>

                            <li className="footer__item">
                                <h6 className="footer__title">Как найти нас ?</h6>
                                <img src={Maps} alt="Map" className="footer__map" width={331} height={229} />
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="footer__box">
                        <p className="footer__pBox"> ©"Kharkivmebel, 2005 - 2021.</p>
                        <img src={allIcon} alt="Icons all" />
                        <p className="footer__pBox"> Created & Powered by </p>
                    </div>
                </div>
            </footer>
        </>
